...
public class Catalog {
    ...
    static public Map<String, Product> ProductsMap = ImmutableMap.<String, Product>builder()
            ...
            .put("ITUNES_GOLD_1", new ProductMoney("ITUNES_GOLD_1", "com.epiceleven.futbolcuatro.gold_1", Money.of(CurrencyUnit.EUR, 2.99), "product_gold_1", "images/icon-BuyGold1.png", Money.of(MoneyUtils.CURRENCY_GOLD, 30), Money.of(MoneyUtils.CURRENCY_GOLD, 0), false))
            .put("ITUNES_GOLD_2", new ProductMoney("ITUNES_GOLD_2", "com.epiceleven.futbolcuatro.gold_2", Money.of(CurrencyUnit.EUR, 4.99), "product_gold_2", "images/icon-BuyGold2.png", Money.of(MoneyUtils.CURRENCY_GOLD, 50), Money.of(MoneyUtils.CURRENCY_GOLD, 5), true))
            .put("ITUNES_GOLD_3", new ProductMoney("ITUNES_GOLD_3", "com.epiceleven.futbolcuatro.gold_3", Money.of(CurrencyUnit.EUR, 9.99), "product_gold_3", "images/icon-BuyGold3.png", Money.of(MoneyUtils.CURRENCY_GOLD, 120), Money.of(MoneyUtils.CURRENCY_GOLD, 15), false))
            .put("ITUNES_GOLD_4", new ProductMoney("ITUNES_GOLD_4", "com.epiceleven.futbolcuatro.gold_4", Money.of(CurrencyUnit.EUR, 19.99), "product_gold_4", "images/icon-BuyGold4.png", Money.of(MoneyUtils.CURRENCY_GOLD, 250), Money.of(MoneyUtils.CURRENCY_GOLD, 50), false))
    ...
    static public List<Product> iTunesProducts = ImmutableList.<Product>builder()
            .add(ProductsMap.get("ITUNES_GOLD_1"))
            .add(ProductsMap.get("ITUNES_GOLD_2"))
            .add(ProductsMap.get("ITUNES_GOLD_3"))
