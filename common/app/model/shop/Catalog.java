...
public class Catalog {
    ...
    static public Map<String, Product> ProductsMap = ImmutableMap.<String, Product>builder()
            ...
            .put("GOLD_6", new ProductMoney("GOLD_6", Money.of(CurrencyUnit.EUR, 99.99), "product_gold_6", "images/icon-BuyGold6.png", Money.of(MoneyUtils.CURRENCY_GOLD, 1600), Money.of(MoneyUtils.CURRENCY_GOLD, 650), false))
