...
public class Catalog {
    ...
    static public Map<String, Product> ProductsMap = ImmutableMap.<String, Product>builder()
            .put("GOLD_1", new ProductMoney("GOLD_1", Money.of(CurrencyUnit.EUR, 2.99), "product_gold_1", "images/icon-BuyGold1.png", Money.of(MoneyUtils.CURRENCY_GOLD, 10), Money.of(MoneyUtils.CURRENCY_GOLD, 0), false))
            .put("GOLD_2", new ProductMoney("GOLD_2", Money.of(CurrencyUnit.EUR, 4.99), "product_gold_2", "images/icon-BuyGold2.png", Money.of(MoneyUtils.CURRENCY_GOLD, 55), Money.of(MoneyUtils.CURRENCY_GOLD, 5), true))
            .put("GOLD_3", new ProductMoney("GOLD_3", Money.of(CurrencyUnit.EUR, 9.99), "product_gold_3", "images/icon-BuyGold3.png", Money.of(MoneyUtils.CURRENCY_GOLD, 115), Money.of(MoneyUtils.CURRENCY_GOLD, 15), false))
            ...
            .put("GOLD_6", new ProductMoney("GOLD_6", Money.of(CurrencyUnit.EUR, 99.99), "product_gold_6", "images/icon-BuyGold6.png", Money.of(MoneyUtils.CURRENCY_GOLD, 1650), Money.of(MoneyUtils.CURRENCY_GOLD, 650), false))
